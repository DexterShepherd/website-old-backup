...
module.exports = () => {
  ...
  new p5(p => {
    let palettes, palette, speed, size, num_circles, radius, particles, counter;

    p.preload = function() {
      palettes = p.loadJSON(require('../data/kuler-palette.json'));
    }
    ...
    p.draw = function() {
      ...
      for(let i = 0; i < particles.length; i++) {
        ...
        if(i < num_circles) {
          ...
          p.stroke(240, p.map(counter, 0, 1000, 255, 0));
        }
        particles[i].display();
      }
