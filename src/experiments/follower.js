  ...
  load: () => {
    ...
    new p5(p => {
      ...
      p.setup = function() {
        ...
        particles4 = [];
        for(let i = 0; i < 100; i++) {
          particles[i] = new Particle(p, p.createVector(p.random(200, 500), p.random(300, 500)));
          particles2[i] = new Particle(p, p.createVector(p.random(200, 500), p.random(300, 500)));
          particles3[i] = new Particle(p, p.createVector(p.random(200, 500), p.random(300, 500)));
          particles4[i] = new Particle(p, p.createVector(p.random(200, 500), p.random(300, 500)));
        }
        p.background(235);
      }
